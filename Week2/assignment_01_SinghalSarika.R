...
greater_days <- table(week1_sleep)
print(greater_days)
count_greater_days <- greater_days[names(greater_days)>8]
print(count_greater_days)
...
grades <- matrix(students_combined, nrow = 3)
print(grades)

## Add a new student row with `rbind()`

student04 <- c(95.2, 94.1)
student04_matrix <- matrix(student04,nrow = 1)
print(student04_matrix)
grades <- rbind(grades, student04_matrix)
print(grades)
...
ringbearers_df <- characters_df["ring_bearer"]
